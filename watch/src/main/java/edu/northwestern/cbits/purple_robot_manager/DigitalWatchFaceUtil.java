...
public class DigitalWatchFaceUtil
{
    ...
    public static final int COLOR_VALUE_AMBIENT_BACKGROUND = parseColor(COLOR_NAME_AMBIENT_BACKGROUND);

    public static final String COLOR_NAME_DEFAULT_BACKGROUND = "Purple";
    public static final int COLOR_VALUE_DEFAULT_BACKGROUND = 0xff4a148c;
