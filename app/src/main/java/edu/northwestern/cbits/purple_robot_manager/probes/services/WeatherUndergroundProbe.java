...
public class WeatherUndergroundProbe extends Feature
{
    ...
    {
        return WeatherUndergroundProbe.DEFAULT_ENABLED;
    }
    ...
    {
        return "edu.northwestern.cbits.purple_robot_manager.probes.services.WeatherUndergroundProbe";
    }
    ...
    public boolean isEnabled(Context context)
    {
        if (!this._isInited)
        {
            ...
            SharedPreferences prefs = Probe.getPreferences(context);
            prefs.edit().putLong(WeatherUndergroundProbe.LAST_CHECK, 0).apply();
