...
public class WakeLockManager
{
    ...
    private LongSparseArray<PowerManager.WakeLock> _partialLocks = new LongSparseArray<>();
    private LongSparseArray<PowerManager.WakeLock> _dimLocks = new LongSparseArray<>();
    private LongSparseArray<PowerManager.WakeLock> _brightLocks = new LongSparseArray<>();
    private LongSparseArray<PowerManager.WakeLock> _fullLocks = new LongSparseArray<>();

    private LongSparseArray<String> _tags = new LongSparseArray<>();
    ...
    public synchronized PowerManager.WakeLock requestWakeLock(int lockType, String tag)
    {
    ...
    public synchronized void releaseWakeLock(PowerManager.WakeLock lock)
    {
    ...
    private synchronized ArrayList<Bundle> locks(LongSparseArray<PowerManager.WakeLock> locks, String lockType) {
