...
public class ProbeTrigger extends Trigger
{
    ...
    public boolean matches(Context context, Object object)
    {
        ...
        if (this._test == null || now - this._lastUpdate < 1000)
            return false;
    ...
    public boolean probeExists(Context context) {
        return (ProbeManager.probeForName(this._probe, context) != null);
    }
    ...
    {
//        Log.e("PR", "TEST PROBE MATCH " + this._probe + " = ? " + probeName + " => " + probeName.equals(this._probe));
