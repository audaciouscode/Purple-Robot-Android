...
public class ManagerService extends IntentService
{
    ...
    {
        PowerManager.WakeLock lock = WakeLockManager.getInstance(this).requestWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "manager-service");

        String action = intent.getAction();

        HashMap<String, Object> payload = new HashMap<>();
        payload.put("manager_service_action", action);

        LogManager.getInstance(this).log(LogManager.DEBUG, "manager_service_intent", payload);
    ...
    public static void setupPeriodicCheck(final Context context)
    {
        ...
        LogManager.getInstance(context).log(LogManager.DEBUG, "manager_service_setup_periodic_check", null);
