            ...
            if (prefs.getBoolean(GooglePlacesProbe.ENABLED, GooglePlacesProbe.DEFAULT_ENABLED)) {
                ...
                if (now - this._lastCheck > 300000) // 5 minutes
                {
                    ...
                    if (this._client == null) {
                        ...
                        this._lastCheck = 0;
                    } else if (this._client.isConnected() && ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
