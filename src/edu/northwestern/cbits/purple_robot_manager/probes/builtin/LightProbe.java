                    ...
                    Runnable r = new Runnable() {
                        ...
                        public void run() {
                            ...
                            for (int i = 0; i < fieldNames.length; i++) {
                                double[] values = new double[myValueBuffer[i].length];

                                for (int j = 0; j < values.length; j++)
                                    values[j] = myValueBuffer[i][j];
                            ...
                            for (int j = 0; j < myTimeBuffer.length; j++) {
                                ...
                                for (int i = 0; i < fieldNames.length; i++) {
                                    if (fieldNames[i].equals(LightProbe.LIGHT_KEY))
                                        light = (double) myValueBuffer[i][j];
                                }
                                ...
                                if (light != null) {
                                    ...
                                    ProbeValuesProvider.getProvider(me._context).insertValue(me._context, LightProbe.DB_TABLE, me.databaseSchema(), values);
                                }
                            }
