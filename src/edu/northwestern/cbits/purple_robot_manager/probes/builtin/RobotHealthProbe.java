...
public class RobotHealthProbe extends Probe
{
    ...
    protected static final String DEVICE_RUNTIME = "DEVICE_RUNTIME";
    protected static final String POWER_SAVE_MODE = "POWER_SAVE_MODE";
                        ...
                        if (plugin != null && plugin instanceof HttpUploadPlugin)
                        {
                            ...
                            Runnable r = new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    ...
                                    bundle.putLong(RobotHealthProbe.DEVICE_RUNTIME, SystemClock.elapsedRealtime());
                                    ...
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                                    {
                                        ...
                                        bundle.putBoolean(RobotHealthProbe.POWER_SAVE_MODE, power.isPowerSaveMode());
                                    }
